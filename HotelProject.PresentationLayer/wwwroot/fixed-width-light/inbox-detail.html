					...
					<ul id="app_dr" class="collapse collapse-level-1">
						...
						<li>
							...
							<ul id="email_dr" class="collapse collapse-level-2">
								...
								<li>
									<a class="active-page" href="inbox-detail.html">detail email</a>
								</li>
							</ul>
						</li>
						<li>
														...
														<div class="panel-body inbox-body pa-0">
															...
															<div class="container-fluid attachment-mail mt-40 mb-40">
																...
																<ul>
																	...
																	<li>
																		<a href="#" class="atch-thumb">
																			<div class="attached-img-container" style="background-image:url(dist/img/gallery/equal-size/mock2.jpg)"></div>
																			<div class="file-name">
																				Image 2
																			</div>
																		</a>
																	...
																	<li>
																		<a href="#" class="atch-thumb">
																			<div class="attached-img-container" style="background-image:url(dist/img/gallery/equal-size/mock3.jpg)"></div>
																			<div class="file-name">
																				Image 3
																			</div>
																		</a>
